  ...
  return (
    <div className="flex flex-col p-6">
      ...
      <p className="text-gray-600">
        ...
        <br />
        The tech stack for this app is: Ruby on Rails, React, Redux, TailwindCSS, and postgres. <strong>This is a mobile first app and does not have desktop styling </strong>
        ...
        <br />
        <strong>Notes:</strong> You can click on the park icons on the home page to see the progress for each park. 
        The icon will fill with color as attractions are completed, bronze for shows, and gold for restaurants. 
      </p>
    </div>
  )
}
