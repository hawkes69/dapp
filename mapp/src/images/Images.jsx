const IMAGES = {
  ...
  dinoland: new URL("./maps/animalKingdom/dinoland.png", import.meta.url).href,
  ...
  epcotMap: new URL("./maps/epcot-map.png", import.meta.url).href,
  epcotLines: new URL("./maps/epcot-lines.png", import.meta.url).href,
  ...
  toyStoryLand: new URL("./maps/hollywoodStudios/toy-story-land.png", import.meta.url).href,
  ...
  libertySquare: new URL("./maps/magicKingdom/liberty-square.png", import.meta.url).href,
  mainStreet: new URL("./maps/magicKingdom/main-street.png", import.meta.url).href,
  ...
  islandsOfAdventureLines: new URL("./maps/islandsOfAdventure/islands-of-adventure-lines.png", import.meta.url).href,
  ...
  woodyWoodpecker: new URL("./maps/universalStudios/woody-woodpecker.png", import.meta.url).href,
};
